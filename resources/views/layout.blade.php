                        ...
                        <div class="split-vertical-cell">
                            <div data-scrollable>
                                ...
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'my-info') active @endif"><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                                </ul> 
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'ticket') active @endif"><a href="{{ route('OpenTicket') }}"><span>Open Ticket</span></a></li>
                                </ul> 
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'my-info') active @endif"><a href="{{ route('my-info') }}"><span>My Info</span></a></li>
                                </ul> 

                                <!-- CHANGE LOG -->
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'my-change-history') active @endif"><a href="{{ route('my-change-history') }}"><i class="fa fa-refresh"></i> <span>My Change History</span></a></li>
                                </ul> 
                                ...
                                <ul class="sidebar-menu sm-bordered sm-active-item-bg">
                                    <li class="hasSubmenu {{ in_array(Route::currentRouteName(), array( 'add-new-product' , 'product-list', 'product-details' )) ? 'open' : ''}}">
                                        <a href="#submenu-products" aria-expanded="{{ in_array(Route::currentRouteName(), array( 'add-new-product' , 'product-list', 'product-details')) ? 'true' : 'false' }}"></i> <span>Products</span></a>   
                                        <ul id="submenu-products" aria-expanded="{{ in_array(Route::currentRouteName(), array( 'add-new-product' , 'product-list', 'product-details')) ? 'true' : 'false' }}" class="{{ in_array(Route::currentRouteName(), array( 'add-new-product' , 'product-list', 'product-details')) ? 'in' : '' }}">
                                            <li class="@if(Route::currentRouteName() == 'add-new-product') active @endif"><a href="{{ route('add-new-product') }}"><i class="fa fa-plus"></i> <span>Add Product</span></a></li>
                                ...
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'order') active @endif"><a href="{{ route('vendor.withdraw_page') }}"><span>Withdraw</span></a></li>
                                </ul>
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'order') active @endif"><a href="{{ route('order.view') }}"><i class="fa fa-gear"></i> <span>Manage Order</span></a></li>
                                </ul>
                                
                                <!-- STORE LOOKS -->
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'store-looks') active @endif"><a href="{{ route('store-looks') }}"><i class="fa fa-gear"></i> <span>Store Looks</span></a></li>
                                </ul>

                                <!-- STORE LOOKS -->
                                <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                    <li class="@if(Route::currentRouteName() == 'shipping-fee') active @endif"><a href="{{ route('shipping-fee') }}"><i class="fa fa-gear"></i> <span>Shipping Fee Setting</span></a></li>
                                </ul>
