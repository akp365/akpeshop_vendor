...
class MenuOneController extends Controller
{
            ...
            return DataTables::of( $data )
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if ($row->status == "active") {
                        $editUrl = route('edit-menu-1', ['menuId' => $row->id]);
                        $btn = '   
    ...
    function addNewMenu(Request $request)
    {
        ...
        else 
        {
            ...
            return view('menus_1.addMenu', compact('pages'));
        }
    }
    ...
    {
        //GET MENU INSTANCE
        $menu = MenuOne::find($request->input('itemId'));
    ...
    public function editMenu(Request $request, $menuId)
    {
        ...
        else 
        {
            ...
            return view('menus_1.editMenu', $this->viewData);
        }
    }
}
