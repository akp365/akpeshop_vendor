    ...
    <div class="panel-body">
        <form method="POST" id="updateProductForm" enctype="multipart/form-data" action="{{ route('update-product') }}">
                            ...
                            <select style="width: 100%;" id="productCategoryDropdown" name="product_cat" data-toggle="select2" name="" data-placeholder="select category.." data-allow-clear="false" data-live-search="true" >
                                ...
                                @if(isset($categoryList) && $categoryList->isNotEmpty())
                                    @foreach($categoryList as $key => $data)
                                        <option value="{{ $data->category->id }}"  @if($product->category_id == $data->category->id) selected @endif>{{ $data->category->title }}</option>
                                    @endforeach
                                @endif
                            </select>
            ...
            <div class="content" style="box-shadow: 0px 0px 5px 2px #dcdcdc; padding:5px;">
                ...
                <div class="row">
                    @for($imageKey = 1; $imageKey<=10; $imageKey++)
                        @if( $product->images->{'image_' . $imageKey} )
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="taxTitleDiv">
                        <div class="form-group form-control-default">
                            ...
                            <input type="number" class="form-control retail_price_input" id="rewardPointInput" placeholder="reward point" value="{{ $product->reward_point }}" disabled readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4" id="taxTitleDiv">
                        <div class="form-group form-control-default">
                            ...
                            <input type="text" class="form-control" id="dealTitleInput" placeholder="hot deal" value="{{ $product->hot_deal }}" disabled readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4" id="taxTitleDiv">
                        <div class="form-group form-control-default required">
                            ...
                            <div class="input-group">
                                <input type="number" value="{{ $product->deal_time }}" class="form-control" id="dealTimeInput" placeholder="deal time" value="{{ $product->deal_time }}" disabled readonly>
                                <span class="input-group-addon" style="color: black;">Days</span>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    /** INITIATION COMPONENTS */
        ...
        $('#brandLogo').akpUploader({showControls:showControls});

        //INITIATE PHOTO UPLOADER FOR PRODUCT-IMAGES
        $('#image_1').akpUploader({showControls:showControls});
        $('#image_2').akpUploader({showControls:showControls});
        $('#image_3').akpUploader({showControls:showControls});
        $('#image_4').akpUploader({showControls:showControls});
        $('#image_5').akpUploader({showControls:showControls});
        $('#image_6').akpUploader({showControls:showControls});
        $('#image_7').akpUploader({showControls:showControls});
        $('#image_8').akpUploader({showControls:showControls});
        $('#image_9').akpUploader({showControls:showControls});
        $('#image_10').akpUploader({showControls:showControls});

        $('.akpUploader').akpUploader({iconsOnly: true, showControls:showControls});
    /** */
