                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-control-default required">
                            ...
                            <label for="shippingFee">Currency</label>
                              <!-- Dropdown Element -->
                              <select style="width: 100%;" id="wholeSaleOptionDropdown" data-toggle="select2" name="shipping_currency" data-placeholder="select wholesale availability.." data-allow-clear="false" data-live-search="true">
                                <option></option>
                            ...
                            <script>
                                ...
                                $(document).ready(function() {
                                    $('#wholeSaleOptionDropdown').select2({
                                        placeholder: 'select wholesale availability..',
                                        allowClear: false
                                    });
                                });
                            </script>
