...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('open-ticket', [App\Http\Controllers\VendorController::class, 'OpenTicketList'])->name('OpenTicket');
    Route::get('/open-ticket/view/{ticket_unique_id}', [VendorController::class, 'OpenTicketView'])->name('OpenTicketView');
    Route::post("/send-message", [VendorController::class, 'SendTicketMessage'])->name('SendTicketMessage');
    //UPDATE SELLER INFO
    ...
    Route::get('order/details', [OrderController::class, 'order_details'])->name('order.details');
    // Route::get('order/list',[OrderController::class, 'orderList'])->name('order-list');
    // Route::get('orders/more-info', [CustomerPanelController::class, 'order_more_info'])->name('order_more_info');
    ...
    Route::get('/withdraw', [WithdrawBalanceController::class,'index'])->name('vendor.withdraw_page');
    Route::post('/withdraw-request', [WithdrawBalanceController::class,'WithdrawRequest'])->name('vendor.withdraw_request');

});


Route::get('/get-total-sells',[VendorController::class,'get_total_sells'])->name('get_total_sells');
...
Route::post('/update-order-status', [VendorController::class, 'updateOrder'])->name('updateOrder');
