...
<h4 class="page-section-heading">Pending for Final Approvals</h4>
...
<script type="text/javascript">
    ...
    $(function() {
        datasTable = $('.data-table').DataTable({
            ...
            createdRow: function ( row, data, index ) {
                if ( data.account_status == 'final_declined' ) 
                {
    ...
    function changeStatus(itemID, newStatus) {
        var waitPopUp;
        var statusText = newStatus == 1 ? "active" : "final_declined";
